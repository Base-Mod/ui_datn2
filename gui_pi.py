...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.warningLabel.setGeometry(QtCore.QRect(70, 2, 120, 18))
        self.warningLabel.setStyleSheet("color: #2ecc71; font-size: 8px; font-weight: bold;")
        self.warningLabel.setAlignment(QtCore.Qt.AlignCenter)
        self.warningLabel.setText("")
        self.warningLabel.setObjectName("warningLabel")
        
        # Power Chart Area (left - larger)
        self.chartWidget = QtWidgets.QWidget(self.REPORT)
        self.chartWidget.setGeometry(QtCore.QRect(5, 22, 185, 148))
        ...
        self.chartTitle.setGeometry(QtCore.QRect(5, 22, 185, 14))
        self.chartTitle.setText("")
        self.chartTitle.setStyleSheet("background: transparent;")
        
        # Total Power Label (inside chart bottom)
        self.totalPowerLabel = QtWidgets.QLabel(self.REPORT)
        self.totalPowerLabel.setGeometry(QtCore.QRect(5, 155, 185, 14))
        self.totalPowerLabel.setStyleSheet("color: #00d4ff; font-size: 9px; font-weight: bold; background: transparent;")
        self.totalPowerLabel.setAlignment(QtCore.Qt.AlignCenter)
        self.totalPowerLabel.setText("Tổng: 0 W")
        
        # Pie Chart Area (center)
        self.pieWidget = QtWidgets.QWidget(self.REPORT)
        self.pieWidget.setGeometry(QtCore.QRect(195, 2, 100, 168))
        ...
        # Table (right side - full height)
        self.REPORTTB = QtWidgets.QTableWidget(self.REPORT)
        self.REPORTTB.setGeometry(QtCore.QRect(300, 2, 95, 168))
